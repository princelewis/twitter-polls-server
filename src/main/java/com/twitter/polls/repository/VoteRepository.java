...
public interface VoteRepository extends JpaRepository<Vote, Long> {
    ...
    //This is a JpQL 
    //The @Param is used for naming-parameterized query
    @Query("SELECT NEW com.twitter.polls.model.ChoiceVoteCount(v.choice.id, count(v.id)) FROM Vote v WHERE v.poll.id in :pollIds GROUP BY v.choice.id")
